...
This is the readme for main, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Main) > Ok.
...
- To run the project find Main.java (which will be in under src/main/java/main) and right click > Run 'Main'
